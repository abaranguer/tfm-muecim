...
import json
import numpy as np
from tfm_ModelTokensBuilder import ModelTokensBuilder
from tfm_LabelLoader import LabelLoader
import pandas as pd
import pickle

class _50LabelsDataFrameBuilderBase:
    def __init__(self, baseDir, fileIndex, dataFrameFileName, modelName):
        ...
        self.tknzr = ModelTokensBuilder(modelName)
        self.label2Ix = {}
        self.ix2Label = {}
        self.loadLabelsDict()
        self.loadFiles()
    ...
    def dataToTokens(self, data):
        ...
        inputIds, attentionMask = self.tknzr.tokenize(lines)
    ...
    def saveDataFrame(self):
        ...
        print(f'50 Labels {self.modelName} CSV DataFrame Created')
...
if __name__ == '__main__':
    ...
    print('Building 50 labels model CSV Dataframe\n')
    baseDir = '.'
    _50LabelsDataFrameBuilderBase(baseDir,
                                  '50LabelsLabelSetFileIndex.txt',
                                  '50LabelsLlama3.3.70BDataset.csv',
