...
import json
import numpy as np
from tfm_DeepSeekTokensBuilder import DeepSeekTokensBuilder
from tfm_LabelLoader import LabelLoader
import pandas as pd
import pickle

class _50LabelsDeepSeekEURLEX57KDataFrameBuilder:
    def __init__(self, baseDir, fileIndex, dataFrameFileName):
        ...
        self.listFiles = {}
        self.dataSet = []
        self.bertTknzr = DeepSeekTokensBuilder()
        self.label2Ix = {}
        self.ix2Label = {}
        self.loadLabelsDict()
        self.loadFiles()
    ...
    def saveDataFrame(self):
        ...
        print('50 Labels Bert CSV DataFrame Created')

        
if __name__ == '__main__':
    os.system("clear")
    print('Build Reduced to 50LabelsDeepSeek CSV Dataframe\n')
    baseDir = '.'
    _50LabelsDeepSeekEURLEX57KDataFrameBuilder(baseDir,
                                           '50LabelsLabelSetFileIndex.txt',
                                           '50LabelsDeepSeekEURLEX57KDataFrame.csv')
