...
class _50LabelsBertEURLEX57KDataFrameBuilder:
    def __init__(self, baseDir, fileIndex, dataFrameFileName):
        ...
        self.listFiles = {}
        self.dataSet = []
        self.bertTknzr = BERTTokensBuilder(modelName='bert-base-cased')
        self.label2Ix = {}
        self.ix2Label = {}
        self.loadLabelsDict()
        self.loadFiles()
...
if __name__ == '__main__':
    os.system("clear")
    print('Build Reduced to 50LabelsBert CSV Dataframe\n')
    baseDir = '.'
    _50LabelsBertEURLEX57KDataFrameBuilder(baseDir,
                                           '50LabelsLabelSetFileIndex.txt',
                                           '50LabelsBertEURLEX57KDataFrame.csv')
