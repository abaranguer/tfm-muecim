...
class ReducedEURLEX57KDataFrameBuilder:
    ...
    def saveDataFrame(self):
        ...
        print('REeduced CSV DataFrame Created')

        
if __name__ == '__main__':
    os.system("clear")
    print('Build Reduced CSV Dataframe\n')
    baseDir = '.'
    ReducedEURLEX57KDataFrameBuilder(baseDir, 'ReducedFileIndex.txt', 'ReducedEURLEX57KDataFrame.csv')
